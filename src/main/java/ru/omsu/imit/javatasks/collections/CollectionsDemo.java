...
public class CollectionsDemo {
    ...
    /**
     * Задание 8
     * Из отображения предыдущей задачи построить список идентификаторов людей, чей возраст не менее 18 лет.
     *
    ...
    /**
     * Задание 9
     * Из отображения предыдущей задачи построить новое отображение, которое идентификатору возраста возраст человека.
     *
     * @param humanMap набор людей, каждому человеку задан уникальный целочисленный идентификатор.
     ...
     * @return список всех людей данного возраста из входного множества.
     */
