...
//TODO 17. Разработайте класс Vector3DProcessor с методами:
//TODO 4) проверка коллинеарности двух векторов.

//TODO 18. Разработайте класс Vector3DArray (массив трехмерных векторов). Методы:
//TODO 4) наибольшая длина вектора в массиве,
//TODO 5) поиск заданного вектора в массиве (результат – индекс первого вхождения или –1, если не найден),
//TODO 6) сумма всех векторов в массиве,
